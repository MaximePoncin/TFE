...
class PartnersContact extends Component {
  constructor(props) {
    super(props);
  ...
  handleSubmit(e) {
    if(this.validateForm(e)) {
      const payload = {
        ...
        subject: Locale[localStorage.getItem('LPC_beerTour_locale')].mail.partnersContact.subject + "/ " + this.state.email,
    ...
    return(
      <Grid>
        <Row className="show-grid">
          <Col xs={12}>
            <h1>{Locale[localStorage.getItem('LPC_beerTour_locale')].partnersContact.partnersContact}</h1>
          </Col>
        </Row>
        <form onSubmit={this.handleSubmit} className="sm">
          <Row className="show-grid">
            <Col xs={6}>
              ...
              >
                <ControlLabel>{Locale[localStorage.getItem('LPC_beerTour_locale')].partnersContact.partnerEmail}</ControlLabel>
                <FormControl
                  name="email"
                  type="email"
          ...
          <Row className="show-grid">
            <Col xs={6}>
              ...
              >
                <ControlLabel>{Locale[localStorage.getItem('LPC_beerTour_locale')].partnersContact.partnerText}</ControlLabel>
                <FormControl
                  name="text"
