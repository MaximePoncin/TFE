const Joi = require('joi'),
      ...
      BoardTypeSchema = require('../../schema/booking/boardType');
 ...
 [
  {
    ...
    handler: (request, h) => {
      return fetch(BookingManagerConf.uri + BookingManagerConf.boardTypePath, {
        method: 'GET',
        headers: {
  ...
  },
  {
    ...
    handler: (request, h) => {
      return fetch(BookingManagerConf.uri + BookingManagerConf.boardTypePath + "/" + request.params.id, {
        method: 'GET',
        headers: {
          'Authorization': request.headers.authorization,
        }
