            ...
            <fieldset>
              ...
              <Row className="show-grid">
                  <Col xs={10}>
                    ...
                    >
                      <ControlLabel>{[localStorage.getItem('LPC_beerTour_locale')].register.phone}</ControlLabel>
                      <FormControl
                        name="userPhone"
                        type="text"
              ...
              <Row className="show-grid">
                  <Col xs={10}>
                    ...
                    >
                      <ControlLabel>{[localStorage.getItem('LPC_beerTour_locale')].register.password}</ControlLabel>
                      <FormControl
                        name="userPassword"
                        type="password"
              ...
              <Row className="show-grid">
                  <Col xs={10}>
                    ...
                    >
                      <ControlLabel>{[localStorage.getItem('LPC_beerTour_locale')].register.passwordConf}</ControlLabel>
                      <FormControl
          ...
          <fieldset>
            ...
            <Row className="show-grid">
                <Col xs={10}>
                  ...
                  >
                    <ControlLabel>{[localStorage.getItem('LPC_beerTour_locale')].register.postalCode}</ControlLabel>
                    <FormControl
                      name="userPostalCode"
                      type="text"
            ...
            <Row className="show-grid">
                <Col xs={10}>
                  ...
                  >
                    <ControlLabel>{[localStorage.getItem('LPC_beerTour_locale')].register.city}</ControlLabel>
                    <FormControl
                      name="userCity"
                      type="text"
                ...
                <Col xs={10}>
                  ...
                  >
                    ...
                    <FormControl
                      ...
                      placeholder={[localStorage.getItem('LPC_beerTour_locale')][localStorage.getItem('LPC_beerTour_locale')].register.countryPlaceholder}
                      onChange={this.handleUserInput}
                      required
                    />
                    <HelpBlock>
